...
now, we need to enhance the quality of the skills. let's improve the topic of T10, and review ALL the skills in that one topic. so read and then update this file:

/media/binyu/USB2/dev/CreatiCodeSkillMap/skillsv3/skills_T10_lists_tables.md
...
Also you need to check this topic against other topics, especially 1/2/3/4/5/12 to ensure no duplicates and skills progress well from grade to grades.
