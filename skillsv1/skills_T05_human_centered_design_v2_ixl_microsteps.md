# T05 – Human‑Centered Design & Simulation Planning: K–8 Skill List (v2, IXL‑Style Microsteps)

Topic reference: `T05 Human-Centered Design & Simulation Planning` in `domains_topics_overview.md`  
Domain: Algorithms & Design (D1) · Primary CSTA focus: ALG‑HD, DAA‑DI (with links to ALG‑IM, ALG‑AF, PRO‑PF)

This v2 version refines the original draft (`skills_T05_human_centered_design.md`) into an **IXL‑style microstep design**:

- **Role of T05:** Focused on *human‑centered design* (empathy, user needs, accessibility, iteration) and *simulation planning* (simplifying reality, defining variables and rules, planning experiments).  
- **Microsteps:** Each skill targets a small, explicit practice (identify needs, describe a user, spot usability issues, choose accessibility improvements, define what a simulation will model, etc.) rather than broad design bundles.  
- **Uneven density:** Heavier scaffolding in **grades 3–6**, where students start designing their own apps and simulations with CreatiCode; lighter but meaningful K–2 foundations and more analytical 7–8 work.  
- **Implementability:** All skills can be run as picture‑based tasks, small planning forms, or structured prompts around CreatiCode projects; no free‑form essays required to auto‑grade.

IDs follow `T05.G<grade>.<nn>`. v1 IDs are preserved conceptually; new microsteps use higher `<nn>` values.

---

## Grade K (PreK–K) – People, Needs, and “Helps”

Strands: **K‑A People & helpers**, **K‑B Easy vs hard to use**
...
Students pick one change (bigger button, clearer text, speaker icon for sound) that would help a character use a device.  
_Format:_ Scenario + MCQ; auto‑graded. · _CSTA:_ EK‑ALG‑HD‑02.

---

## Grade 1 – Simple Needs and Improvements

Strands: **1‑A Understand user needs**, **1‑B Propose small improvements**
...
## Grade 2 – User Types, Preferences, and Simple Simulations

Strands: **2‑A User types & preferences**, **2‑B Simple simulation ideas**
...
Students see scenarios (traffic light, plant growth, simple weather) and choose which could be simulated on a computer.  
...
Students decide which 2–3 elements are important to include in a picture‑based simulation (e.g., “rain” and “sun” for plant growth).  
_Format:_ Multi‑select; auto‑graded. · _CSTA:_ E2‑DAA‑DI‑01.

---

## Grade 3 – Basic HCD Process and Tiny Simulations

Strands: **3‑A HCD steps (empathize → design → test)**, **3‑B Plan tiny simulations**
...
Students choose what the main “thing that changes” is in a simple simulation (e.g., plant height, number of cars).  
_Format:_ MCQ; auto‑graded. · _CSTA:_ E3‑DAA‑DI‑02.

**T05.G3.05 – Select simple rules for a simulation**  
Students pick rules such as “if it rains, plant grows taller” from options to define simulation behavior.  
_Format:_ Multi‑select; auto‑graded. · _CSTA:_ E3‑DAA‑DI‑02.

---

## Grade 4 – Personas, Accessibility, and Simulation Simplifications

Strands: **4‑A Personas & scenarios**, **4‑B Accessibility patterns**, **4‑C Simplifying simulations**
...
## Grade 5 – Structured HCD and Simulation Planning

Strands: **5‑A HCD artifacts (needs, requirements, sketches)**, **5‑B Simulation variables & rules**, **5‑C Plan evaluation**
...
Students list or select variables (e.g., “number of rabbits”) and their starting values from a story.  
_Format:_ Table completion; auto‑graded. · _CSTA:_ E5‑DAA‑DI‑02.

**T05.G5.04 – Draft simple update rules for a simulation**  
Students choose or write rules for how variables change each step (e.g., “each month, rabbits double”).  
...
## Grade 6 – Formal HCD Cycles and Simulation Design Tradeoffs

Strands: **6‑A Apply HCD principles**, **6‑B User research & feedback cycles**, **6‑C Simulation design & justification**
...
Students complete a planning template listing variables, rules, and simple UI for a simulation idea.  
...
## Grade 7 – Accessibility, Harms, and Data‑Driven Improvements

Strands: **7‑A Accessibility audits**, **7‑B Harms & mitigation**, **7‑C Data‑driven iterations**
...
## Grade 8 – Advanced HCD, Simulation Experiments, and Documentation

Strands: **8‑A Plan and document HCD projects**, **8‑B Design and analyze simulation experiments**, **8‑C Communicate design decisions**
...
- K–2: T05 builds on general reasoning and picture‑based tasks; depends lightly on T01/T02 for sequence and representation ideas.  
- G3–5: HCD and simulation planning skills depend on basic project ideas and data concepts from other topics (e.g., T03 decomposition, T25–T27 data), but remain concept‑level, not heavy coding.  
- G6–8: T05 skills assume students can build small apps and simulations (T06–T13, T17, T25–T27) and focus on planning, evaluation, and iteration using HCD and DAA‑DI practices.  
- This design matches CSTA ALG‑HD and DAA‑DI progressions, keeping each skill narrow, auto‑gradable, and CreatiCode‑implementable.
