# T20 – Algorithmic Art & Creative Coding: K–8 Skill List (Draft v2)
...
Grades K‑2 stay unplugged/picture‑based (no blocks yet). Coding begins in Grade 3 and ramps up through Grade 8. All skills should feel playful and art‑driven, with clear scaffolds between grades and to adjacent topics (loops, data, media, AI).

---

## Grade K (PreK–K)

Kindergarten students play with picture cards, stickers, and drag‑and‑drop manipulatives to notice repeating art ideas. Activities are tactile and story‑based, emphasizing observation and sequencing rather than coding.

### T20.GK.01 – Picture pattern detective

- **Short name:** Spot repeating art patterns
...
- **Challenge format:** Picture-based multi-select. Show 3–4 illustrated rows; students tap all rows that repeat correctly. Include audio hints for emerging readers. Auto-grading checks selected rows.
- **CSTA:** EK‑ALG‑AF‑01.
...
- **Challenge format:** Interactive drag-and-drop. Show the start of a path plus a bin of stickers; students drag the next 2–3 stickers into place. Auto-grading checks order and approximate placement.
- **CSTA:** EK‑ALG‑AF‑01.

### T20.GK.04 – Fix the mixed-up art plan

- **Short name:** Debug the art steps
...
- **Challenge format:** Picture multiple choice. Highlight the incorrect card and offer 2–3 replacements. Auto-grading checks the chosen correction.
- **CSTA:** EK‑ALG‑AF‑01, EK‑PRO‑TR‑01.

---

## Grade 1

Grade 1 learners describe patterns verbally, connect step-by-step directions to artworks, and begin debugging directions. Tasks remain unplugged but include more explicit reasoning about rules.
...
- **Challenge format:** Concept, matching. Two direction cards and two drawings; students map them correctly. Auto-grading checks matches.
...
- **Challenge format:** Concept, multiple choice with illustrations. Highlight the problematic step and offer replacement options. Auto-grading checks their choice.
- **CSTA:** E1‑PRO‑TR‑01.
...
Grade 2 bridges from descriptive art talk to structured “recipes.” Learners experiment with mini repeat cards, symmetry, and layered instructions—still without using block code.
...
- **Challenge format:** Drag-and-drop on a grid with a mirror line. Students drag tiles to the empty side. Auto-grading checks mirrored placement.
- **CSTA:** E2‑ALG‑AF‑01.
...
- **Challenge format:** Concept, short response or selectable statements. Students choose or record the correct effect. Auto-grading checks the selected explanation.
- **CSTA:** E2‑ALG‑AF‑01.
...
Grade 3 is the transition into CreatiCode blocks. Students still begin with unplugged planning, then quickly move into simple pen commands, loops, and tracing.
...
- **Challenge format:** Coding, starter project. Provide sprites with pen blocks; prompt: “Use a loop to draw 6 stars across the page.” Auto-grading checks for loop usage and icon placement.
- **CSTA:** E3‑PRO‑PF‑01.
...
- **Challenge format:** Coding, starter project. Provide base code; students insert randomness while preserving structure. Auto-grading runs multiple times to ensure variation within bounds.
...
- **Challenge format:** Coding, mini-project. Provide UI button sprites; students add event handlers that change variables/pens and redraw. Auto-grading checks for event blocks and different color sets.
- **CSTA:** E4‑PRO‑PF‑01.
...
- **Challenge format:** Coding, interactive challenge. Provide base art. Students add at least one mouse and one keyboard event to modify variables/colors. Auto-grading checks event blocks and responsive output.
- **CSTA:** E5‑PRO‑PF‑01.
...
- **Challenge format:** Concept, short written/audio reflection tied to their project. Auto-grading uses rubric/ranked statements.
- **CSTA:** DAA‑DI, CAS‑ET.
...
Grade 6 students analyze more complex scripts, refactor for clarity, and connect art to math and datasets with conditionals and transformations.
...
- **Challenge format:** Coding, refactor activity. Provide large starter script. Auto-grading inspects for new loops/blocks and compares output snapshot to baseline.
...
- **CSTA:** MS‑PRO‑PF‑01, E4‑ALG‑AF‑01 (extended).

---

## Grade 7

Grade 7 shifts toward optimization, advanced control flow, and real-world inspirations such as L-systems and generative art pieces.
...
- **Challenge format:** Coding, starter project. Auto-grading checks loop type and stopping condition tied to sprite state.
- **CSTA:** MS‑PRO‑PF‑01.
...
- **Challenge format:** Coding, guided challenge. Provide rule cards; students loop through iterations. Auto-grading checks for correct rule application counts and resulting visuals.
- **CSTA:** MS‑PRO‑PF‑01.
...
- **Challenge format:** Concept, structured response referencing case studies. Auto-grading uses rubric with key ideas.
- **CSTA:** CAS‑ET, MS‑IMP (Computing impacts).
...
- **Challenge format:** Coding, capstone extension. Auto-grading checks for at least two distinct algorithmic stages plus documentation of how they interact.
- **CSTA:** MS‑PRO‑PF‑01, DAA‑DI.
