# T27 – Data Analysis & Storytelling: K–8 Skill List (Draft v2)

Topic reference: `T27 Data Analysis` in `domains_topics_overview.md`
Domain: Data & Analysis (D3) · CSTA focus: DAA‑DP, DAA‑DI (links to PRO‑PF, CAS‑ET)
...
**Role and scope in v3:** T27 completes the T25→T26→T27 pipeline by turning collected, well-structured data into insights and stories. Grades K–2 interpret picture charts and notice simple patterns (no coding). Grades 3–5 build CreatiCode-powered charts (lists, tables, graph widgets) and justify claims using evidence. Grades 6–8 run comparative experiments, write queries, and communicate findings responsibly—including bias checks, dashboards, and decision memos used by AI-powered teams (T21–T24). Analysis is inseparable from storytelling: every skill requires interpreting patterns and communicating them clearly to peers or virtual assistants.
...
- **Short name:** Tell what rule you used
...
- **Challenge format:** Concept sorting. Auto-grading checks both sorting accuracy and a recorded sentence about the rule.
- **CSTA:** EK‑DAA‑DF‑01.
...
- **Challenge format:** Concept. Auto-grading checks selected category and a simple reason (“Because it has more apples”).
- **CSTA:** EK‑DAA‑DI‑03.
...
- **Challenge format:** Short response. Auto-grading looks for key words referencing chart evidence.
- **CSTA:** E1‑DAA‑DI‑02.
...
- **Challenge format:** Concept Q&A. Auto-grading checks comprehension responses.
- **CSTA:** E2‑DAA‑DI‑02.
...
- **Challenge format:** Concept. Auto-grading checks decision and explanation.
- **CSTA:** E2‑DAA‑DF‑01.
...
- **Challenge format:** Short answer referencing specific numbers. Auto-grading checks format and accuracy.
- **CSTA:** E3‑DAA‑DI‑02.
...
- **Challenge format:** Coding or template. Auto-grading ensures both groups present and labeled.
- **CSTA:** E3‑DAA‑DI‑02.
...
- **Challenge format:** Short writing. Auto-grading ensures captions cite specific values.
- **CSTA:** E4‑DAA‑DI‑02.
...
- **Challenge format:** Presentation upload. Rubric scoring checks for chart accuracy and actionable recommendations.
- **CSTA:** E5‑PRO‑PM‑04.
...
- **Challenge format:** Coding + reflection. Auto-grading verifies residual calculations and requires a paragraph describing a detected pattern.
- **CSTA:** MS‑DAA‑DI‑03, CAS‑ET.
...
- **Challenge format:** Writing. Rubric scoring checks structure and accuracy.
- **CSTA:** MS‑PRO‑PM‑03.
...
- **Challenge format:** Coding. Auto-grading triggers the script to ensure outputs refresh with new data.
- **CSTA:** MS‑PRO‑PF‑02, DAA‑DP.
...
- **Challenge format:** Presentation. Rubric scoring checks for multiple components (data, context, ethics, recommendation).
