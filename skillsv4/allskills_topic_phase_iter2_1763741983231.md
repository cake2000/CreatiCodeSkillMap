...
ID: T34.G4.03
Topic: T34 – Computing History
Skill: Link hardware evolution to modern software features
Description: Students connect historical hardware advances (GPU invention, cloud computing, touchscreens) to features they use today in apps, games, and tools like CreatiCode (3D graphics, AI blocks).
...
* T34.G6.03: Learn from historical computing failures


ID: T34.G7.02
Topic: T34 – Computing History
Skill: Evaluate technology policies over time
Description: Students examine how technology policies evolved historically (COPPA, early computer misuse acts, privacy regulations) and discuss their motivations and outcomes.

Dependencies:
* T34.G6.01: Analyze waves of computing (mainframe → mobile → AI)
* T34.G6.02: Evaluate historical inclusion and exclusion in computing


ID: T34.G7.03
Topic: T34 – Computing History
Skill: Create presentations about computing pioneers
Description: Learners research a computing pioneer and create a presentation (digital poster, slideshow, or simple CreatiCode scene) highlighting their contributions and modern relevance.
...
Description: Students analyze historical patterns (processor speeds, adoption curves, AI progress) and write evidence-based forecasts for future technologies (AI tutors, AR classrooms, quantum computing).
...
Description: Learners investigate how policies, education, and industry shaped computing in two different regions (e.g., Kenya's mobile payment innovation vs Estonia's e-government) and link findings to historical roots.

Dependencies:
* T34.G7.02: Evaluate technology policies over time
* T34.G7.03: Create presentations about computing pioneers


ID: T34.G8.03
Topic: T34 – Computing History
Skill: Produce primary-source research projects
Description: Students gather primary sources (oral histories, historical documents, archival photos) and create a multimedia presentation connecting computing history lessons to their own projects or interests.
...
Description: Students sort information cards (name, favorite color, home address, birthday, pet's name) into 'okay to share online' and 'keep private' piles, explaining their reasoning.
...
Description: Students compare two mock 'For You' feeds and identify why different users see different content, then discuss how viewing history shapes recommendations.
...
Description: Students use block coding to build an interactive pledge where users click to commit to positive online behaviors (be kind, protect privacy, ask before sharing) and see encouraging responses.
...
Description: Learners research a specific technology (e.g., mobile banking, telemedicine, agricultural drones) and create a comparison chart showing its benefits and challenges in two different communities, explaining why impacts differ.
...
ID: T35.G5.04
Topic: T35 – Impacts & Ethics
Skill: Identify stakeholders affected by technology decisions
Description: Students map all people affected by a technology choice (developers, users, bystanders, future generations) and use block coding to create a simple visualization showing different perspectives and potential impacts.

Dependencies:
* T35.G4.01: Analyze case studies of tech helping/harming communities
* T06.G4.01: Broadcast a custom message and respond with a second sprite
...
Description: Learners design and conduct structured interviews with 3+ stakeholders (teachers, parents, students) about a local AI policy question, then create a summary of areas of agreement and disagreement on AI governance, connecting to T21-T24 applications.
...
Description: Learners synthesize evidence from at least two sources into a one-page policy brief recommending equitable AI use in schools, addressing differential access to T21-T24 tools, bias in AI outputs, and privacy protection with specific action items.
...
Description: Learners ask classmates or family members simple questions about what they would like in a CreatiCode app and summarize two key ideas they learned.
...
Dependencies:
* T36.G3.04: Explore what coders and digital designers do
* T36.G3.01: Ask classmates simple questions to understand project needs
...
Description: Students interview (in person, virtually, or via recorded profiles) diverse tech professionals from various backgrounds, exploring their career journeys, daily work, challenges faced, and advice for students.
