# T01 – Everyday Algorithms & Step‑by‑Step Thinking: K–8 Skill List (v6, IXL‑Style Microsteps)
...
Students find which action happens over and over in a picture‑based routine.  
